...
import com.example.checkpoint2.service.MercadoBitcoinServiceFactory
...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeCallRequest(){
        CoroutineScope(Dispatchers.Main).launch{
            ...
            } catch (e: Exception){ Toast.makeText(this@MainActivity, "Falha na chamada: ${e.message}", Toast.LENGTH_LONG).show()}
        }
    }
